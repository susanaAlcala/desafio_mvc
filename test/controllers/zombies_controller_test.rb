...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { kills: @zombie.kills, name: @zombie.name, weapon: @zombie.weapon } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { kills: @zombie.kills, name: @zombie.name, weapon: @zombie.weapon } }
